  ...
  $.flexslider = function(el, options) {
    ...
    slider.init = function() {
      ...
      if (slider.vars.directionNav) {
        var directionNavScaffold = $('<ul class="flex-direction-nav"><li><a class="prev" href="#"><i class="icon-chevron-left"></i></a></li><li><a class="next" href="#"><i class="icon-chevron-right"></i></a></li></ul>');
