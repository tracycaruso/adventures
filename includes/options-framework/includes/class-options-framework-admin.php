...
class Options_Framework_Admin {
	...
	function enqueue_admin_styles() {
		wp_enqueue_style( 'optionsframework', of_dir . 'css/optionsframework.css', array(),  Options_Framework::VERSION );
	...
	function enqueue_admin_scripts( $hook ) {
		...
		wp_enqueue_script( 'options-custom',  of_dir . 'js/options-custom.js', array( 'jquery','wp-color-picker' ), Options_Framework::VERSION );
